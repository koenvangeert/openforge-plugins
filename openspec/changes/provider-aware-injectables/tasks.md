...
- [ ] 2.1 Encode the local-folder × provider matrix from design.md in one module, and verify unit tests cover Grok reading `.claude` and `.agents`, Claude reading only `.claude`, and Codex/Pi/OpenCode reading `.agents`
